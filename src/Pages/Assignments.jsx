    ...
    <div>
      ...
      <div className='mr-[20%] ml-[10%] px-8 font-poppins'>
        ...
        <div className="mt-[80px]">
          ...
          {assignments.length > 0 ? (
            assignments.map((assignment) => (
              <div key={assignment.id} className="bg-white flex justify-between items-center">
                <Link
                  to={`/assignments/${assignment.assignmentId}`}
                  className="flex-1"
                  onClick={() => localStorage.setItem('assignmentId', assignment.id)} // Save departmentId to localStorage
                >
        ...
        >
          ...
          >
            ...
            <form onSubmit={handleEdit}>
              ...
              <div className="mb-6">
                <label htmlFor="assignmentName" className="block mb-2 text-blue-950 text-lg font-semibold">
                  Assignment Name
                </label>
                <input
                  type="text"
                  ...
                  onChange={(e) =>
                    setEditingAssignment({ ...editingAssignment, assignmentName: e.target.value })
                  }
                  className="border border-blue-950 p-2 rounded w-full"
                />
              </div>
              <div className="mb-6">
                <label htmlFor="assingmentPercentage" className="block mb-2 text-blue-950 text-lg font-semibold">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditingAssignment({ ...editingAssignment, assingmentPercentage: e.target.value })
                  }
                  className="border border-blue-950 p-2 rounded w-full"
                />
              </div>
              <div className="mb-6">
                <label htmlFor="assignmentDuration" className="block mb-2 text-blue-950 text-lg font-semibold">
                  Assignment Duration
                </label>
                <input
                  type="text"
                  ...
                  onChange={(e) =>
                    setEditingAssignment({ ...editingAssignment, assignmentDuration: e.target.value })
                  }
                  className="border border-blue-950 p-2 rounded w-full"
                />
              </div>
