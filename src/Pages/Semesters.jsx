...
//             const filteredSemesters = data.filter(semester => semester.degreename === degreename);
...
//                     <Link to={`/departments/${semesters.degreename}/intakes/semesters`} key={semesters.id}>
